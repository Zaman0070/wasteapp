...
class BeneficiaryService extends StatefulWidget {
  @override
  State<BeneficiaryService> createState() => _BeneficiaryServiceState();
}

class _BeneficiaryServiceState extends State<BeneficiaryService> {
  bool mada = false;
                ...
                children: [
                  ...
                  MyButton(
                    ...
                    onPressed: () {
                      ...
                      //     .push(MaterialPageRoute(builder: (context) => The()));
                    },
                  )
                ],
              ),
