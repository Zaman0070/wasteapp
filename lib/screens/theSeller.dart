...
import 'package:wasit_bussiness_app/screens/serviceProvider.dart';
import 'package:wasit_bussiness_app/screens/theBuyer.dart';
...
class _TheSellerState extends State<TheSeller> {
  ...
  bool second = false;
  Object _itemValue;
  var itemList = ['1st أيام', '2nd أيام', '3rd أيام', '4th أيام'];
  @override
            ...
            MyButton(
              ...
              onPressed: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => TheBuyer()));
              },
            )
          ]),
        ),
